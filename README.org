...
| Split window top and bottom          | ~C-x 2~   | ~split-window-below~         | Make two panes, one above, and one below         |
| Split window left and right          | ~C-x 3~   | ~split-window-right~         | Make two panes, one on the right and on the left |
